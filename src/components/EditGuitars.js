...
const EditGuitars = () => {
  ...
  const update = (id, name, description, price, stock) => {
    axios.put(url, {
      id: id,
      nombre: name,
    ...
    <div id="modalGuitars" className="fixed flex top-0 left-0 w-full h-full bg-gray-500 bg-opacity-75 justify-center items-center">
      <div className="bg-white rounded-lg shadow-md p-4 w-1/2">
        ...
        <div className="d-grid col-6 mx-auto">
          <button onClick={() => update(id, name, description, price, stock)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
